...
* `^`:  It will only do updates that do not change the leftmost non-zero number. If you write `^0.13.0`, when running `npm update`, it can update patch and minor releases `0.13.1`, `0.13.2`, and `0.14.0` or above.
